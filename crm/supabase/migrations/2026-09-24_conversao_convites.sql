-- BV Seguros · CRM: conversão de lead em cliente e registo de convites feitos pelo CRM.
-- Correr uma vez no SQL Editor do Supabase, depois de 2026-09-24_nome_utilizador.sql.
...
-- ============================================================
-- Convites enviados pelo CRM (api/utilizadores.js) ficam no histórico de acessos.
-- ============================================================
...
alter table public.eventos_acesso
  ...
  check (alteracao in ('acesso_dado', 'acesso_retirado', 'tornado_admin', 'tornado_mediador', 'nome_alterado', 'convidado'));
